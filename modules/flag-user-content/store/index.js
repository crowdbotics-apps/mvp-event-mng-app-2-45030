...
export const createReport = createAsyncThunk("FlagUserContent/createReport", async payload => {
  try {
...
export const getChoices = createAsyncThunk("FlagUserContent/getChoices", async () => {
  try {
...
export const getReportedList = createAsyncThunk("FlagUserContent/getReportedList", async () => {
  try {
